        ...
        <main className="flex-1">
          <div className="container max-w-screen-2xl px-4 py-6 lg:py-8">
            <div className="mx-auto max-w-4xl">
              ...
              <div
                className={`shadow ${
                  theme == "dark" ? "bg-zinc-900 text-gray-300" : "bg-gray-50 text-zinc-900 shadow-inner"
              ...
              >
                ...
                <div className="mb-2 sm:mb-4 md:mb-2">
                  <div className="flex items-center h-[50px] sm:h-[70px] md:h-[100px]">
                    <SVGComponent color="#87BFE5" size="32" className="sm:size-10 md:size-14" />
                    <SVGLabel
                      color="red"
                ...
                <p className="max-w-[280px] sm:max-w-md md:max-w-2xl text-xs sm:text-sm md:text-base leading-snug sm:leading-relaxed">
                  <span className="font-semibold">AutoXLR8</span> is a data quality and validation management platform
                  designed to ensure accuracy, consistency, and compliance across enterprise data sources. It provides
                  an end-to-end framework for defining domains, configuring resources, applying validation rules, and
                  executing queries across multiple systems.
                </p>
              </div>
              ...
              <div className="space-y-8 mb-8">
                <section className="space-y-4">
                  ...
                  <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
                    <li className="flex items-start">
                      ...
                      Integrate with multiple data sources through Linked Services (e.g., local files, SFTP, SQL, Azure
                      SQL)
                    </li>
                    <li className="flex items-start">
                      <span className="text-primary mr-2">•</span>
                ...
                {/* Core Modules */}
                <section className="space-y-4">
                  <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Core Modules of the System:</h2>
                  <ol className="space-y-2 text-sm sm:text-base text-muted-foreground">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Research Queries</strong> → Provides query building, execution, and results
                        visualization
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Audit and History</strong> → Tracks domain changes, rule executions, and validation
                        history
                      </span>
                    </li>
                  </ol>
                ...
                {/* Benefits */}
                <section className="space-y-4">
                  <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Benefits of AutoXLR8:</h2>
                  <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
                    <li className="flex items-start">
                      <span className="text-primary mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-primary mr-2">•</span>
                      Supports both technical users (SQL, custom validations) and business users (predefined templates,
                      dashboards)
                    </li>
                    <li className="flex items-start">
                      <span className="text-primary mr-2">•</span>
