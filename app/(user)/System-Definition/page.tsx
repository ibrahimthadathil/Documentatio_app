            ...
            <div className="mx-auto max-w-4xl">
              ...
              >
                ...
                <p className="max-w-[280px] sm:max-w-md md:max-w-2xl text-xs sm:text-sm md:text-base leading-snug sm:leading-relaxed">
                  ...
                  designed to ensure accuracy, consistency, and compliance
                  across enterprise data sources. It provides an end-to-end
                  framework for defining domains, configuring resources,
                  applying validation rules, and executing queries across
                  multiple systems.
                </p>
              </div>
