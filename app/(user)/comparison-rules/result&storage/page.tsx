            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground max-w-2xl">
                  After the comparison, the system generates results. You can
                  choose how these results are stored and viewed.
                </p>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 pl-4">
                    ...
                    <li>
                      <strong>Store Summary Only:</strong> Keeps a high-level
                      overview (e.g., number of mismatches, affected fields).
                    </li>
                    <li>
                      <strong>Choose Both:</strong> You can configure the system
                      to store detailed and summary information based on your
                      needs.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground max-w-2xl">
                    Comparison rules can be part of automated testing pipelines.
                    This means results can be automatically validated as part of
