...
<div className="space-y-6">
  <h2 className="text-xl font-semibold">Creating Custom Validation Rules</h2>
  <p className="text-muted-foreground max-w-2xl">
    Users can define their own validation rules through the Rule Builder interface.
  </p>
  ...
  <div>
    ...
    <ol className="list-decimal list-inside space-y-1 pl-4">
      ...
      <li>
        Enter <strong>Rule Name</strong>, <strong>Category</strong>, and <strong>Description</strong>.
      </li>
      <li>
        Select the <strong>Target Domain/Resource</strong> the rule will apply to.
      </li>
      <li>
        Define the <strong>Logic</strong>:
        <ul className="list-disc list-inside space-y-1 pl-4">
          <li>Choose condition type (Not Null, Format, Range, Lookup, SQL Expression).</li>
          <li>Specify parameters (column, min/max, pattern, reference table).</li>
